...
interface TractorIncidentHistoryTableProps {
  tractorId: string;
}

const TractorIncidentHistoryTable: React.FC<
  TractorIncidentHistoryTableProps
> = ({ tractorId }) => {
  ...
  useEffect(() => {
    const loadIncidents = async () => {
      setLoading(true);
      try {
        const response = await getVehicleIncidentHistory(tractorId, 1);
    ...
    return (
      ...
      >
        ...
        <Typography variant="body2" color="text.secondary">
          Đầu kéo này chưa có báo cáo sự cố nào.
        </Typography>
      </Box>
    );
  }
...
export default TractorIncidentHistoryTable;
