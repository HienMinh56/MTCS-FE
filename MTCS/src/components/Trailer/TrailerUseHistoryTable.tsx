...
import { TrailerUseHistory } from "../../types/trailer";
import { Link as RouterLink } from "react-router-dom";
import { useAuth } from "../../contexts/AuthContext"; // Import useAuth hook

interface TrailerUseHistoryTableProps {
  historyData: {
...
const TrailerUseHistoryTable: React.FC<TrailerUseHistoryTableProps> = ({
  historyData,
  loading,
  onPageChange,
  onPageSizeChange,
    ...
    return (
      <Box p={3} textAlign="center">
        <Typography color="textSecondary">
          Không có lịch sử sử dụng rơ-moóc
        </Typography>
      </Box>
    );
  }
...
export default TrailerUseHistoryTable;
