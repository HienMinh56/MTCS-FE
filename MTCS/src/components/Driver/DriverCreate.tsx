...
import { createDriverWithFiles, FileUpload } from "../../services/DriverApi";
import {
  DriverForm,
  DriverFormValues,
...
const DriverCreate: React.FC<DriverCreateProps> = ({ onClose, onSuccess }) => {
  const navigate = useNavigate();
  const [isSubmitting, setIsSubmitting] = useState(false);
  const [fileUploads, setFileUploads] = useState<FileUploadWithCustom[]>([]);
  ...
  const onSubmit = async (data: DriverFormValues) => {
    ...
    try {
      ...
      let errorMessage = "Không thể tạo tài xế. Vui lòng thử lại.";
                              ...
                              <Grid item xs={12}>
                                <FormControl size="small" fullWidth>
                                  ...
                                  <Select
                                    ...
                                    label="Loại tài liệu"
                                  >
                                    {FILE_DESCRIPTION_OPTIONS.map((option) => (
